...
Вкладки: **Профиль** (уровень, статы, исследования, способности, где я и мои территории с названиями карт, склад и инвентарь, друзья с уровнем и кланом), **Изучение** (схема технологий, клик по узлу — путь и сколько часов осталось), **Крафт** (раскладка до сырья с отметкой своих техов), **Рынок** (поиск по терминалам и магазинам: кто что отдаёт и за что, курс, сводка цен по искомому предмету — без выручки и складов продавцов; собирается в фоне раз в 5 мин), **Карта** (свои участки и «вы здесь» поверх карты с туманом войны: видно 20 клеток вокруг персонажа и своих участков, туман накладывается на сервере — целая карта наружу не уходит; поворот как в админке, по умолчанию 315°, и масштаб), **Клан** (состав, роли, специализации, клан-техи, рост и события — без личных техов/исследований участников), **Сервер** (статус, онлайн за 24 ч, сезонный рейтинг, торговцы, кланы, кто сейчас на сервере). Галочка «Запомнить меня» — вход на 30 дней (на диске только хэш токена, гаснет при смене пароля в игре).
