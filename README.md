...
| **playerweb** | Панель для игроков (по умолчанию порт `80`, выключена): вход ником и игровым паролем, только своё — профиль, инвентарь, схема изучения, раскладка крафта, свой клан, статус сервера и рейтинги |
