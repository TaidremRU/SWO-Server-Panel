...
| **playerweb** | Панель для игроков (по умолчанию порт `80`, выключена): вход ником и игровым паролем, только своё — профиль, инвентарь, схема изучения, крафт из своего инвентаря, свой клан, статус сервера и рейтинги |
...
Вкладки: **Профиль** (уровень, статы, исследование, где я и мои территории, склад и инвентарь), **Изучение** (схема технологий, клик по узлу — путь и сколько часов осталось), **Крафт** (раскладка до сырья с отметкой своих техов; «могу скрафтить из того, что есть» и «не хватает одного ресурса»), **Клан** (состав, специализации, клан-техи, рост и события), **Сервер** (статус, онлайн, сезонный рейтинг, топы исследователей/торговцев/кланов).
